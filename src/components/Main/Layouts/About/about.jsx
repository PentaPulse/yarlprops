            ...
            <div className="about-row">
                    ...
                    <div className="col-md-12 text-center">
                        <h2 className="about-section-title">
                            The TeamBehind the Project
                        </h2>
                        <p className="about-section-subtitle">{message}</p>
                    </div>
                    
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        <div className="col-sm-4 col-md-2">
                            <div className="card">
                                <img src="https://demo.epic-webdesign.com/tf-pacifico/v1/images/team1a.jpg" alt="pic" className="card-img-top" />
                                <h3 class="card-title">THARINDU SACHINTHA</h3>
                                <div className="card-body">
                                    <p>Team Leader</p>
                                    <p class="card-text" >Sachintha is the leader of our PentaPulse team. He has developed websites for a variaty of clients.</p>
                        ...
                        <div className="col-sm-4 col-md-2">
                            <div className="card">
                                <img src="https://demo.epic-webdesign.com/tf-pacifico/v1/images/team1a.jpg" alt="pic" className="card-img-top" />
                                <h3 class="card-title">CHARITH RAJAPAKSHA</h3>
                                <div className="card-body">
                                    <p>Team Member</p>
                                    <p class="card-text" >Charith is the member of our PentaPulse team. He has developed websites for a variaty of clients.</p>
                        ...
                        <div className="col-sm-4 col-md-2">
                            <div className="card">
                                <img src="https://demo.epic-webdesign.com/tf-pacifico/v1/images/team1a.jpg" alt="pic" className="card-img-top" />
                                <h3 class="card-title">MITH S JAYAKODY</h3>
                                <div className="card-body">
                                    <p>Team member</p>
                                    <p class="card-text" >Mith is the member of our PentaPulse team. He has developed websites for a variaty of clients.</p>
                        ...
                        <div className="col-sm-4 col-md-2">
                            <div className="card">
                                <img src="https://demo.epic-webdesign.com/tf-pacifico/v1/images/team2a.jpg" alt="pic" className="card-img-top" />
                                <h3 class="card-title">JANANY WELIPITIYA</h3>
                                <div className="card-body">
                                    <p>Team member</p>
                                    <p class="card-text" >Janani is the member of our PentaPulse team. He has developed websites for a variaty of clients.</p>
                        ...
                        <div className="col-sm-4 col-md-2">
                            <div className="card">
                                <img src="https://demo.epic-webdesign.com/tf-pacifico/v1/images/team2a.jpg" alt="pic" className="card-img-top" />
                                <h3 class="card-title">PRIYADARSHANI</h3>
                                <div className="card-body">
                                    <p>Team member</p>
                                    <p class="card-text" >Priyadrshani is the member of our PentaPulse team. He has developed websites for a variaty of clients.</p>
