...
export default function NavigationBar({
  ...
  const SignBox = ({ sign, closeSign, Comp }) => {
    return (
      ...
      >
        <Fade in={sign}>
          <Box sx={style}>{sign ? <Comp closeBox={closeSign} /> : ""}</Box>
        </Fade>
      </Modal>
    );
  };
          ...
          <Toolbar>
                    ...
                    <>
                      ...
                      <MenuItem key={page} onClick={handleCloseNavMenu}>
                        <Button
                          disabled
                          textAlign="center"
                          onClick={() => navigate("/d/notifications")}
                          sx={{
                            textDecoration: "none",
                            color: theme.palette.primary.main,
                          }}
                      ...
                      <MenuItem onClick={()=>{handleSignout();handleCloseNavMenu()}}>
                        <IconButton
                          size="large"
                          aria-haspopup="true"
                          color="inherit"
            ...
            {isLogged ? (
              ...
              >
                ...
                <ProfileBox
                  isLogged={isLogged}
                  handleProfileClick={handleMobileMenuOpen}
                />
              </Box>
            ) : (
              <>
