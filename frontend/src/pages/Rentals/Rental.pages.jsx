import { Checkbox, Divider, FormControlLabel, FormGroup, Grid, Paper, Slider, TextField, Typography } from '@mui/material';
...
function RentalsContents({searchTerm,selectedCategories,priceRange}){
